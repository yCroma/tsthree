...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const ThreeParamsStore: ThreeParams = new Object();
  ...
  function init(elementId: string) {
    ...
    // モデルをロード
    const model = fbxLoader.load("./test.fbx", (object) => {
      console.log("inner object", object);
      object.scale.set(30, 30, 30);
      ThreeParamsStore.Model = object;
      console.log("Store Model: ", ThreeParamsStore);
      scene.add(object);
    });
  }
  function setParams() {
    const Store = ThreeParamsStore;
    console.log("setStore: ", ThreeParamsStore);
